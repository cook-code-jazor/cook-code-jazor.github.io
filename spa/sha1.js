(function() {
  ...
  const n = function(b) {
    let d
    const e = ((b.length + 8) >> 6) + 1
    const a = new Array(e * 16)
    for (d = 0; d < e * 16; d++) {
      a[d] = 0
    }
  ...
  const o = function(e, a) {
    ...
    const d = (e >> 16) + (a >> 16) + (b >> 16)
    return (d << 16) | (b & 65535)
  }
  const k = function(b, a) {
    return (b << a) | (b >>> (32 - a))
  }
  const f = function(b, d, e, a) {
    if (b < 20) {
      return (d & e) | ((~d) & a)
    }
    if (b < 40) {
  ...
  window.SHA1 = function(b, a) {
    if (typeof b === 'string') {
      b = Utf8Encoding.getBytes(b)
    }
    return r(b, a === true)
  }
})()
